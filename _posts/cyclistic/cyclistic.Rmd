...
description: |
  Looking for tie-based, geographic and product-specific differences between members and casual users using public bikes in Chicago
author:
  - name: Eric Narro
...
output:
  distill::distill_article:
    ...
    keep_md: true
abstract: |
  We compared members and casual users in order to find any differences in their use of Cyclistic's service using internal data. Rides done by members have more uniform patterns that those done by casual users. Most rides are done by members, they are also usually under 35 minutes, they happen during working weekdays more often. Casual users rides are usually longer, sometimes over 45 minutes and happen more during the weekends. During hotter months, both groups increase the amount of rides, but casual users do in a higher proportion. Almost 3/4 of the rides happen in the afternoon, and morning rides are by far mostly done by members. Member rides usually cover a higher area of downtown Chicago, Casual users ride more often in the very East of the Town. Members ride classic bikes 60% of the time, casual users ride electric bikes and classic bikes in an even amount. A considerable amount of members seem to be Unversity students. Casual users seem to use the service for leisure more often than members and there is probably a fair amonunt of tourists. In order to increase memberships, marketing campaings could probably take place in touristic areas of downtown Chicago, during weekends, in the afternoons, and during hot months. Partnering with ocal businesses to add attractivity to the membership could be considered.
keywords: |
  - members
  - users
  - use trends
...
```{r, echo=FALSE}
htmltools::img(src = knitr::image_uri("/home/eric/projects/courses/google_data_analyst/capstone/case_1/data/final_project/cyclistic_logo.png"),
alt = 'logo',
style = 'position:absolute; top:0; right:0; padding:10px; width: 147px; height: 139px; margin-top:70px; float:right')
```

```{css}
h1 {'margin-right:150px'}
```
